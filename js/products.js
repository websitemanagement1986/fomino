...
const CATEGORIES = [
  { slug: 'fresh-fruits', name: 'Fresh Fruits', shortName: 'Fruits', icon: '🍎', color: '#e65100', image: 'https://images.pexels.com/photos/1132047/pexels-photo-1132047.jpeg?auto=compress&cs=tinysrgb&w=500&h=420&fit=crop', tagline: 'Farm-fresh fruits delivered daily', description: 'Seasonal and everyday fruits handpicked for freshness and quality.' },
  { slug: 'fresh-vegetables', name: 'Fresh Vegetables', shortName: 'Vegetables', icon: '🥬', color: '#558b2f', image: 'https://images.pexels.com/photos/533360/pexels-photo-533360.jpeg?auto=compress&cs=tinysrgb&w=500&h=420&fit=crop', tagline: 'Crisp vegetables from local farms', description: 'Daily essentials and seasonal vegetables for your kitchen.' },
  { slug: 'exotic', name: 'Exotic Fruits & Veggies', shortName: 'Exotic', icon: '🥑', color: '#7cb342', image: 'https://images.pexels.com/photos/5946091/pexels-photo-5946091.jpeg?auto=compress&cs=tinysrgb&w=500&h=420&fit=crop', tagline: 'Premium exotic produce', description: 'Broccoli, blueberries, avocado and more specialty items.' },
  { slug: 'organic', name: 'Organic Produce', shortName: 'Organic', icon: '🌿', color: '#33691e', image: 'https://images.pexels.com/photos/2255935/pexels-photo-2255935.jpeg?auto=compress&cs=tinysrgb&w=500&h=420&fit=crop', tagline: 'Certified organic goodness', description: 'Chemical-free organic fruits and vegetables for healthy living.' },
  { slug: 'staples', name: 'Grocery & Staples', shortName: 'Staples', icon: '🌾', color: '#f9a825', image: 'https://images.pexels.com/photos/4110257/pexels-photo-4110257.jpeg?auto=compress&cs=tinysrgb&w=500&h=420&fit=crop', tagline: 'Rice, dal, atta & more', description: 'Daily kitchen staples at great prices.' },
  { slug: 'dairy', name: 'Dairy & Bread', shortName: 'Dairy', icon: '🥛', color: '#5d4037', image: 'https://images.pexels.com/photos/236010/pexels-photo-236010.jpeg?auto=compress&cs=tinysrgb&w=500&h=420&fit=crop', tagline: 'Fresh dairy every morning', description: 'Milk, curd, paneer, bread and bakery essentials.' },
  { slug: 'beverages', name: 'Beverages', shortName: 'Beverages', icon: '🥤', color: '#0277bd', image: 'https://images.pexels.com/photos/143133/pexels-photo-143133.jpeg?auto=compress&cs=tinysrgb&w=500&h=420&fit=crop', tagline: 'Juices, tea & coffee', description: 'Refreshing drinks for every occasion.' },
  { slug: 'snacks', name: 'Snacks', shortName: 'Snacks', icon: '🍪', color: '#bf360c', image: 'https://images.pexels.com/photos/230325/pexels-photo-230325.jpeg?auto=compress&cs=tinysrgb&w=500&h=420&fit=crop', tagline: 'Biscuits & namkeen', description: 'Tea-time snacks and munchies for the family.' },
];
